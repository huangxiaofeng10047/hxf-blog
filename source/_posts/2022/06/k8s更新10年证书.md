...
通过 `./update-kubeadm-cert.sh  all`来生成10年证书

```

[root@k8s-bj-m1 ~]# kubeadm certs check-expiration
[check-expiration] Reading configuration from the cluster...
[check-expiration] FYI: You can look at this config file with 'kubectl -n kube-system get cm kubeadm-config -o yaml'
W0616 12:24:42.875543   11310 utils.go:69] The recommended value for "clusterDNS" in "KubeletConfiguration" is: [10.233.0.10]; the provided value is: [169.254.25.10]

CERTIFICATE                EXPIRES                  RESIDUAL TIME   CERTIFICATE AUTHORITY   EXTERNALLY MANAGED
admin.conf                 Jun 13, 2032 04:24 UTC   9y              ca                      no
apiserver                  Jun 13, 2032 04:24 UTC   9y              ca                      no
apiserver-kubelet-client   Jun 13, 2032 04:24 UTC   9y              ca                      no
controller-manager.conf    Jun 13, 2032 04:24 UTC   9y              ca                      no
front-proxy-client         Jun 13, 2032 04:24 UTC   9y              front-proxy-ca          no
scheduler.conf             Jun 13, 2032 04:24 UTC   9y              ca                      no

CERTIFICATE AUTHORITY   EXPIRES                  RESIDUAL TIME   EXTERNALLY MANAGED
ca                      May 30, 2032 08:32 UTC   9y              no
front-proxy-ca          May 30, 2032 08:32 UTC   9y              no

```

即可生效

参考update-kubeadm-cert.sh
...
[升级k8s证书100年操作说明](https://blog.csdn.net/aeaiesb/article/details/122595775)

```
https://blog.csdn.net/aeaiesb/article/details/122595775
